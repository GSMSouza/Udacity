...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
       ...
       # as classifier label
       model_label = classifier(str(images_dir)+str(image_name), model)
       ...
       model_label = image_name.lower().strip()
       ...
       if truth in model_label:
           results_dic[key].exteds(model_label, 1)
       ...
       # the extend function 
           ...
           results_dic[key].exteds(model_label, 0)
